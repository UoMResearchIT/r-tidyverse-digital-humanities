...
We may be prompted to select a mirror to install the package from. You should ideally select a mirror that is close by.  The package will then be installed, along with any packages that it requires to run.
